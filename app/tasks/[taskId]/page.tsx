...
export default function TaskDetailPage() {
  ...
  const task = {
    ...
    description:
      "Create branded graphics for all social media platforms including Facebook, Instagram, Twitter, LinkedIn. Graphics should follow brand guidelines and be optimized for each platform.",
    status: "inprogress",
    priority: "high",
    ...
    comments: [
      {
        ...
        user: "John Doe",
        avatar: "JD",
        text: "Please make sure to include the new logo in all graphics.",
        time: "2 hours ago",
      },
      {
        id: 2,
        user: "Jane Smith",
        avatar: "JS",
        text: "Working on it! Should have the first drafts ready by EOD.",
        time: "1 hour ago",
      },
      {
        id: 3,
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`px-3 py-1.5 rounded-lg text-sm font-medium ${getPriorityColor(task.priority)}`}
                  >
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {task.tags.map((tag, idx) => (
                          <span
                            key={idx}
                            className="px-3 py-1 bg-teal-100 text-teal-700 rounded-lg text-xs font-medium"
                          >
                            #{tag}
                          </span>
                        ))}
