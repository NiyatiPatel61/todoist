          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                ...
                <Link
                  href="/tasks/new"
                  className="px-4 py-2 bg-linear-to-r from-teal-600 to-cyan-600 text-white rounded-xl font-medium hover:from-teal-700 hover:to-cyan-700 transition-all shadow-lg shadow-teal-500/30 flex items-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link href={`/tasks/${task.id}`} className="block">
                          <h3
                            className={`font-semibold text-gray-900 group-hover:text-teal-600 transition-colors mb-2 ${task.status === "completed" ? "line-through text-gray-500" : ""}`}
                          >
                            {task.title}
                          </h3>
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-3 py-1.5 rounded-lg text-xs font-medium capitalize ${getPriorityColor(task.priority)}`}
                        >
                          {task.priority}
                        </span>
                        <span
                          className={`px-3 py-1.5 rounded-lg text-xs font-medium capitalize ${getStatusColor(task.status)}`}
                        >
