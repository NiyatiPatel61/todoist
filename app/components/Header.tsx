    ...
    <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        <button className="p-2 hover:bg-teal-50 rounded-xl transition-all duration-300 hover:scale-110 relative group">
          ...
          <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full ring-2 ring-white animate-pulse"></span>
        </button>
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full flex items-center justify-center text-white font-semibold shadow-lg shadow-teal-500/30 ring-2 ring-white">
