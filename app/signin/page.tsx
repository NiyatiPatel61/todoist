        ...
        <div className="relative z-10">
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 cursor-pointer">
              ...
              <div className="text-teal-100 text-sm font-medium">Active Users</div>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 cursor-pointer">
              <div className="text-4xl font-bold text-white mb-2">50M+</div>
              <div className="text-teal-100 text-sm font-medium">Tasks Done</div>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105 cursor-pointer">
              <div className="text-4xl font-bold text-white mb-2">4.8★</div>
              <div className="text-teal-100 text-sm font-medium">Rating</div>
            </div>
          </div>
        </div>
      </div>
